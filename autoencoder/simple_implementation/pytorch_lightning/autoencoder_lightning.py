...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(mnist_train, batch_size=100, shuffle=True, num_workers=3, pin_memory=True)
    val_loader = DataLoader(mnist_val, batch_size=100, num_workers=3, pin_memory=True)
    ...
    # training
    trainer = pl.Trainer(accelerator='auto', precision=16, max_epochs=10, logger=logger)
